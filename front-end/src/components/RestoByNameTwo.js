...
const RestoByNameTwo = ({ restoByName, reference }) => {
  ...
  console.log("1", chosenRestaurant);
  console.log("2", restoByName);
  console.log("3", reference);

  return (
    <>
      {restoByName
        .filter((resto) => resto.reference === reference)
        .map((resto) => (
          <Wrapper>
            <TextwrapperAll>
              <TextWrapperLeft>
              ...
              <TextWrapperRight>
                <TextRight>Reserve your table at {resto.name} now!</TextRight>
              </TextWrapperRight>
            </TextwrapperAll>
            <BottomwrapperAll>
              {" "}
              <WrapperBottomLeft>
                <RestaurantName>{resto.name}two restos</RestaurantName>
                <TextWrapperInfo>
                  <TextLeftInfo>{resto.rating}</TextLeftInfo>
                  <ReactStars
                    value={resto.rating}
                    name="rating"
                    readOnly="true"
                    isHalf="true"
                  />
                  {/* <TextLeftInfo1>{resto.user_ratings_total} reviews</TextLeftInfo1> */}
                  <TextLeftInfo2>
                    {resto.price_level === 1
                      ? "$"
                      : resto.price_level === 2
                ...
                <TextWrapperDetails>
                  ...
                  <OverviewContent>
                    At {resto.name}, we create great memories by serving out
                  ...
                  <ReviewsContent>
                    See a sample review for {resto.name} here!
                    {resto.photos[0].html_attributions[0] &&
                      resto.photos[0].html_attributions[0].length !== 0 && (
                        <div
                          dangerouslySetInnerHTML={{
                            __html: resto.photos[0].html_attributions[0],
                          }}
                        />
                      )}
                  ...
                  <ContactContent>{resto.formatted_address}</ContactContent>

                  <MapMove>
                    <Map
                      name={resto.name}
                      location={resto.geometry.location}
