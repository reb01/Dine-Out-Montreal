...
const NearYou = ({ dataNearYou, reference }) => {
  ...
  useEffect(() => {
    const passRestaurantName = dataNearYou.results
        ...
        .map((items, index) => (
          <Wrapper>
            ...
            <BottomwrapperAll>
              {" "}
              <WrapperBottomLeft>
                <RestaurantName>{items.name}near you</RestaurantName>
                <TextWrapperInfo>
                ...
                <TextWrapperDetails>
                  ...
                  <ContactContent>{items.vicinity}</ContactContent>
