...
const OpenNow = ({ dataOpenNow, reference }) => {
            ...
            <TextwrapperAll>
              <TextWrapperLeft>
                <Link
                  ...
                  duration={750}
                >
                  <TextLeft>Overview</TextLeft>
                </Link>
                <TextLeft>Reviews</TextLeft>
                <TextLeft>Photos</TextLeft>
                <TextLeft>Contact</TextLeft>
              </TextWrapperLeft>
              <TextWrapperRight>
                <TextRight>Reserve your table now!</TextRight>
              </TextWrapperRight>
            </TextwrapperAll>
            <BottomwrapperAll>
              {" "}
              <WrapperBottomLeft>
                <RestaurantName>{items.name}open now</RestaurantName>
                <TextWrapperInfo>
              ...
              <WrapperBottomRight>
                ...
                <WrapperButton>Reserve my table at "time"</WrapperButton>
              </WrapperBottomRight>
            </BottomwrapperAll>
          </Wrapper>
        ))}
