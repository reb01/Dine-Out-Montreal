...
const RestoByNameOne = ({ restoByName, reference }) => {
  ...
  useEffect(() => {
    const passRestaurantName = restoByName
    ...
    <>
      <Wrapper>
        <TextwrapperAll>
          ...
          <TextWrapperRight>
            <TextRight>
              Reserve your table at {restoByName[0].name} now!
            </TextRight>
          </TextWrapperRight>
        </TextwrapperAll>
        <BottomwrapperAll>
          {" "}
          <WrapperBottomLeft>
            <RestaurantName>{restoByName[0].name}Resto One</RestaurantName>
            <TextWrapperInfo>
              <TextLeftInfo>{restoByName[0].rating}</TextLeftInfo>
              <ReactStars
                ...
                isHalf="true"
              />
              {/* <TextLeftInfo1>{RestoByName[0].user_ratings_total} reviews</TextLeftInfo1> */}
              <TextLeftInfo2>
            ...
            <TextWrapperDetails>
              ...
              <OverviewContent>
                At {restoByName[0].name}, we create great memories by serving
                out original signature dishes using recipes that have been
              ...
              <ReviewsContent>
                See a sample review for {restoByName[0].name} here!
                {restoByName[0].photos[0].html_attributions[0] &&
                  restoByName[0].photos[0].html_attributions[0].length !==
                    0 && (
                    <div
                      dangerouslySetInnerHTML={{
                        __html: restoByName[0].photos[0].html_attributions[0],
                      }}
                    />
                  )}
              ...
              <ContactContent>
                {restoByName[0].formatted_address}
              </ContactContent>

              <MapMove>
                <Map
                  name={restoByName[0].name}
                  location={restoByName[0].geometry.location}
                  address={restoByName[0].formatted_address}
                  zoomLevel={17}
                />
              </MapMove>
              <Divider />
